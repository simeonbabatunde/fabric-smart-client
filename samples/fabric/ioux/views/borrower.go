...
import (
	...
	"github.com/hyperledger-labs/fabric-smart-client/samples/fabric/ioux/states"
)
...
func (i *CreateIOUView) Call(context view.Context) (interface{}, error) {
	...
	borrower, lender, err := state.ExchangeRecipientIdentities(context, view2.GetIdentityProvider(context).Identity(i.Lender))
